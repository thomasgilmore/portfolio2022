...
export default function HeroImage() {
  return (
    <div className='heroImageDiv'>
      <LazyLoadImage src={programmerImageSmall} className="heroImage" srcSet={`${programmerImageSmall} 640w, ${programmerImageMedium} 1280w, ${programmerImageLarge} 2000w`} alt="Person Coding" />
    </div>
  )
}