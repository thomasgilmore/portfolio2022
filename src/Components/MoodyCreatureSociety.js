  ...
  return(
    <div className='moodyCreatureSocietyDiv'>
      <Container>
        ...
        <p>I was given all of the elements for the website (ex. images and text) and they gave me a sketch to follow that was written on a piece of paper. It was definitely one of the more interesting ways to get a design and possibly made it more difficult. However, I’m always up for a good challenge to work on. 
