    ...
    <div className='wineRecommendationsDiv'>
      <Container>
        ...
        <div className="siteLinksDiv">
          <a href="https://gilmore-wine-recommendations-v2.netlify.app/" target="_blank" className={`${theme}ViewSiteLink`}>View Site</a>
          <a href="https://github.com/thomasgilmore95/wine-recommendations-app-v2" target="_blank" className={`${theme}ViewCodeLink`}>View Code</a>
        </div>
