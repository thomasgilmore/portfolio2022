    ...
    <div className='wineRecommendationsDiv'>
      <Container>
        ...
        <div className="siteLinksDiv">
          ...
          <a href="https://github.com/thomasgilmore/wine-recommendations-app-v2" target="_blank" className={`${theme}ViewCodeLink`} rel="noreferrer">View Code</a>
        </div>
        ...
        <p className="projectText">For the Wine Recommendations, I'm using two API endpoints from Spoonacular API. I'm using the get dish pairing for wine where you find a dish that goes well with a given wine and I'm also using get wine pairing that finds a wine that goes well with food.</p>
        <p className="projectText">I used React to create the front end for this project. I used two AJAX calls for the two different API endpoints to return the data to the user and using Netlify to host the app.</p>
